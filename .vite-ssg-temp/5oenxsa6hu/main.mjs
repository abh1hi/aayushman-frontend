...
function _sfc_ssrRender$l(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<header${ssrRenderAttrs(mergeProps({ class: "fixed top-4 left-0 right-0 z-50 px-4 flex justify-center w-full" }, _attrs))} data-v-0f6c2127><div class="md:hidden flex justify-between items-center w-full" data-v-0f6c2127><div class="flex items-center gap-3" data-v-0f6c2127><button class="w-12 h-12 rounded-full bg-black/60 border border-white/10 backdrop-blur-md flex flex-col gap-1.5 items-center justify-center shadow-lg active:scale-95 transition-transform" data-v-0f6c2127><span class="w-5 h-0.5 bg-gray-200 rounded-full" data-v-0f6c2127></span><span class="w-5 h-0.5 bg-gray-200 rounded-full" data-v-0f6c2127></span><span class="w-5 h-0.5 bg-gray-200 rounded-full" data-v-0f6c2127></span></button><a href="tel:+919777995101" class="w-12 h-12 rounded-full bg-black/60 border border-white/10 backdrop-blur-md flex items-center justify-center shadow-lg active:scale-95 transition-transform" data-v-0f6c2127><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-red-500 fill-current" viewBox="0 0 24 24" data-v-0f6c2127><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 1.23 0 2.45.2 3.57.57.35.13.74.04 1.02-.24l2.2 2.2z" data-v-0f6c2127></path></svg></a></div><a href="/" class="flex items-center gap-3 bg-black/30 px-3 py-1.5 rounded-xl backdrop-blur-sm" data-v-0f6c2127><img${ssrRenderAttr("src", _imports_0$1)} alt="ALSA" class="h-10 w-auto object-contain drop-shadow-[0_0_8px_rgba(239,68,68,0.5)]" data-v-0f6c2127><div class="text-left leading-none" data-v-0f6c2127><h1 class="text-white font-bold text-[0.55rem] tracking-wider font-copperplate" data-v-0f6c2127> AYUSHMAAN<br data-v-0f6c2127>LIFE SUPPORT<br data-v-0f6c2127>AMBULANCE® </h1></div></a></div><div class="hidden md:flex header-pill rounded-full px-6 py-3 items-center justify-between w-full max-w-6xl" data-v-0f6c2127><div class="flex items-center gap-3" data-v-0f6c2127><a href="/" class="flex items-center gap-3" data-v-0f6c2127><img${ssrRenderAttr("src", _imports_0$1)} alt="Ayushman Life Support Ambulance" class="h-12 w-auto object-contain" data-v-0f6c2127><div class="text-left leading-tight hidden md:block" data-v-0f6c2127><h1 class="text-white font-bold text-[0.65rem] tracking-wide" data-v-0f6c2127>AYUSHMAN<br data-v-0f6c2127>LIFE SUPPORT<br data-v-0f6c2127>AMBULANCE®</h1></div></a></div><nav class="hidden md:flex items-center gap-8 text-gray-300 text-sm font-medium" data-v-0f6c2127><!--[-->`);
  ssrRenderList(_ctx.navItems, (item, index) => {
    _push(`<div class="relative group cursor-pointer" data-v-0f6c2127><div class="nav-link flex items-center gap-1 hover:text-white transition-colors duration-300" data-v-0f6c2127>${ssrInterpolate(item.name)} <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 opacity-70 group-hover:opacity-100 transition-transform group-hover:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-0f6c2127><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-0f6c2127></path></svg></div>`);
    if (_ctx.activeDropdown === index) {
      _push(`<div class="absolute top-full left-0 mt-4 w-40 bg-gray-900/90 backdrop-blur-md rounded-xl border border-gray-700 p-2 shadow-xl animate-fade-in" data-v-0f6c2127><div class="text-xs text-gray-500 p-2" data-v-0f6c2127>Submenu for ${ssrInterpolate(item.name)}</div></div>`);
    } else {
      _push(`<!---->`);
    }
    _push(`</div>`);
  });
  _push(`<!--]--></nav><div class="liquid-button cursor-pointer" data-v-0f6c2127><span class="text-red-600 font-bold tracking-widest text-sm glow-text uppercase" data-v-0f6c2127> Emergency Call </span></div></div></header>`);
}
...
const Header = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["ssrRender", _sfc_ssrRender$l], ["__scopeId", "data-v-0f6c2127"]]);
const _sfc_main$n = {
  __name: "App",
...
function _sfc_ssrRender$j(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({
    ref: "sectionRef",
    class: "w-full"
  }, _attrs))} data-v-cd58cbf4><div class="md:hidden relative min-h-screen w-full flex flex-col justify-between pt-20 pb-8 px-6 bg-cover bg-center overflow-hidden" style="${ssrRenderStyle({ "background-image": "url('/about-section/second-section.jpeg')" })}" data-v-cd58cbf4><div class="absolute inset-0 bg-black/70 z-0" data-v-cd58cbf4></div><div class="relative z-10 text-center space-y-4 mt-4" data-v-cd58cbf4><div class="flex justify-center mb-4" data-v-cd58cbf4><img${ssrRenderAttr("src", _imports_0$1)} alt="Ayushman Logo" class="h-16 w-auto opacity-100 drop-shadow-md" data-v-cd58cbf4></div><h2 class="text-2xl font-black text-white tracking-widest uppercase leading-tight drop-shadow-lg" data-v-cd58cbf4> MORE THAN A <br data-v-cd58cbf4><span class="text-red-500" data-v-cd58cbf4>SERVICE PROVIDER</span></h2><p class="text-gray-300 text-xs px-2 leading-relaxed max-w-xs mx-auto drop-shadow-md font-medium" data-v-cd58cbf4> ALSA is a Delhi NCR based private EMS provider offering medical transport, emergency response, and critical care solutions, since 2008. </p><div class="flex justify-center gap-4 mt-6 opacity-90" data-v-cd58cbf4><img${ssrRenderAttr("src", _imports_1)} alt="Certification 1" class="h-8 w-auto object-contain grayscale hover:grayscale-0 transition-all" data-v-cd58cbf4><img${ssrRenderAttr("src", _imports_2)} alt="Certification 2" class="h-8 w-auto object-contain grayscale hover:grayscale-0 transition-all" data-v-cd58cbf4></div></div><div class="relative z-10 space-y-3 mt-auto w-full max-w-[360px] mx-auto" data-v-cd58cbf4><div class="bg-black/60 backdrop-blur-md border border-white/10 p-4 rounded-2xl flex items-center gap-4" data-v-cd58cbf4><div class="bg-white/5 p-2 rounded-full shrink-0" data-v-cd58cbf4><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-red-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-cd58cbf4><circle cx="12" cy="12" r="10" data-v-cd58cbf4></circle><line x1="2" y1="12" x2="22" y2="12" data-v-cd58cbf4></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z" data-v-cd58cbf4></path></svg></div><div data-v-cd58cbf4><h3 class="text-white font-bold text-sm leading-tight mb-1" data-v-cd58cbf4>Pan-India Medical Response network</h3><p class="text-gray-400 text-[10px] leading-snug" data-v-cd58cbf4> Emergency and planned medical response across cities, highways, and intercity routes. </p></div></div><div class="bg-black/60 backdrop-blur-md border border-white/10 p-4 rounded-2xl flex items-center gap-4" data-v-cd58cbf4><div class="bg-white/5 p-2 rounded-full shrink-0" data-v-cd58cbf4><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-red-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-cd58cbf4><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" data-v-cd58cbf4></path><path d="M9 12l2 2 4-4" data-v-cd58cbf4></path></svg></div><div data-v-cd58cbf4><h3 class="text-white font-bold text-sm leading-tight mb-1" data-v-cd58cbf4>End to End Emergency &amp; Care Solutions</h3><p class="text-gray-400 text-[10px] leading-snug" data-v-cd58cbf4> Emergency response, critical transfers, hospital coordination, and home care services. </p></div></div></div></div><section class="hidden md:flex mts-section min-h-[80vh] items-center py-20 relative overflow-hidden text-left" style="${ssrRenderStyle({ "background-image": "url('/about-section/second-section.jpeg')" })}" data-v-cd58cbf4><div class="container mx-auto px-4 relative z-10 flex justify-end" data-v-cd58cbf4><div class="${ssrRenderClass([{ "animate-slide-up": _ctx.isVisible }, "w-full md:w-1/2 space-y-8 pl-0 md:pl-12"])}" data-v-cd58cbf4><div data-v-cd58cbf4><h2 class="text-2xl md:text-3xl font-bold text-gray-200 tracking-[0.2em] uppercase mb-4" data-v-cd58cbf4> More Than a Service Provider </h2><p class="text-gray-400 leading-relaxed text-sm md:text-base" data-v-cd58cbf4> ALSA is a Trusted Life Support Ambulance Provider in Delhi NCR, offering rapid response emergency medical transport and critical care solutions since 2008. </p></div><div class="space-y-4" data-v-cd58cbf4><div class="mts-card p-4 md:p-6 rounded-2xl flex items-start gap-4" data-v-cd58cbf4><div class="bg-transparent p-2" data-v-cd58cbf4><svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 text-red-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-cd58cbf4><circle cx="12" cy="12" r="10" data-v-cd58cbf4></circle><line x1="2" y1="12" x2="22" y2="12" data-v-cd58cbf4></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z" data-v-cd58cbf4></path></svg></div><div data-v-cd58cbf4><h3 class="text-white font-bold text-lg mb-1" data-v-cd58cbf4>Pan-India Medical Response network</h3><p class="text-gray-400 text-sm" data-v-cd58cbf4> Emergency and planned medical response across cities, highways, and intercity routes. </p></div></div><div class="mts-card p-4 md:p-6 rounded-2xl flex items-start gap-4" data-v-cd58cbf4><div class="bg-transparent p-2" data-v-cd58cbf4><svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 text-red-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-cd58cbf4><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" data-v-cd58cbf4></path><path d="M9 12l2 2 4-4" data-v-cd58cbf4></path></svg></div><div data-v-cd58cbf4><h3 class="text-white font-bold text-lg mb-1" data-v-cd58cbf4>End to End Emergency &amp; Care Solutions</h3><p class="text-gray-400 text-sm" data-v-cd58cbf4> Emergency response, critical transfers, hospital coordination, and home care services. </p></div></div></div><div class="flex items-center gap-6 pt-4 opacity-80" data-v-cd58cbf4><img${ssrRenderAttr("src", _imports_1)} alt="Certification 1" class="h-16 w-auto object-contain" data-v-cd58cbf4><img${ssrRenderAttr("src", _imports_2)} alt="Certification 2" class="h-16 w-auto object-contain" data-v-cd58cbf4></div></div></div></section></div>`);
}
...
const MoreThanServiceSection = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["ssrRender", _sfc_ssrRender$j], ["__scopeId", "data-v-cd58cbf4"]]);
const _sfc_main$k = {
  setup() {
    const partners = ref([
...
function _sfc_ssrRender$h(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "service-card w-full group hover:shadow-2xl transition-all duration-300 rounded-2xl overflow-hidden relative h-[400px]" }, _attrs))} data-v-9ccdddc7><img${ssrRenderAttr("src", _ctx.image)}${ssrRenderAttr("alt", _ctx.title + " - Ayushman Life Support Ambulance")} class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" data-v-9ccdddc7><div class="card-overlay absolute inset-0 p-8 flex flex-col items-start justify-end text-left pointer-events-none bg-gradient-to-t from-black via-transparent to-transparent group-hover:-translate-y-2 transition-transform duration-300" data-v-9ccdddc7><h3 class="card-title text-xl md:text-2xl font-bold text-white uppercase mb-3 border-b-2 border-transparent group-hover:border-red-500 pb-1 transition-colors" data-v-9ccdddc7>${ssrInterpolate(_ctx.title)}</h3><p class="card-desc text-sm text-gray-300 leading-relaxed max-w-xs opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100 transform translate-y-4 group-hover:translate-y-0" data-v-9ccdddc7>${ssrInterpolate(_ctx.description)}</p></div></div>`);
}
...
const ServiceCard = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["ssrRender", _sfc_ssrRender$h], ["__scopeId", "data-v-9ccdddc7"]]);
const _sfc_main$i = {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "app-footer py-8" }, _attrs))} data-v-4352a182><div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-0" data-v-4352a182><div class="flex items-center gap-3" data-v-4352a182><div class="flex flex-col items-center" data-v-4352a182><img${ssrRenderAttr("src", _imports_0$1)} alt="ALSA Logo" class="w-12 h-auto object-contain" data-v-4352a182></div><div class="text-left leading-tight" data-v-4352a182><h1 class="text-white font-bold text-sm tracking-wide" data-v-4352a182>AYUSHMAN<br data-v-4352a182>LIFE SUPPORT<br data-v-4352a182>AMBULANCE</h1></div></div><nav class="flex items-center flex-wrap justify-center" data-v-4352a182><a href="#" class="footer-nav-link" data-v-4352a182>About us</a><div class="separator hidden md:block" data-v-4352a182></div><a href="#" class="footer-nav-link" data-v-4352a182>Services</a><div class="separator hidden md:block" data-v-4352a182></div><a href="#" class="footer-nav-link" data-v-4352a182>Solutions</a><div class="separator hidden md:block" data-v-4352a182></div><a href="#" class="footer-nav-link" data-v-4352a182>Network</a><div class="separator hidden md:block" data-v-4352a182></div><a href="#" class="footer-nav-link" data-v-4352a182>Explore</a></nav><div class="flex items-center gap-4" data-v-4352a182><a href="#" data-v-4352a182><svg class="social-icon" viewBox="0 0 24 24" data-v-4352a182><path d="M12 2.04C6.5 2.04 2 6.53 2 12.06C2 17.06 5.66 21.21 10.44 21.96V14.96H7.9V12.06H10.44V9.85C10.44 7.34 11.93 5.96 14.15 5.96C15.21 5.96 16.12 6.04 16.12 6.04V8.51H15.01C13.77 8.51 13.38 9.28 13.38 10.07V12.06H16.16L15.72 14.96H13.38V21.96C15.76 21.58 17.9 20.35 19.45 18.52C21 16.69 21.9 14.43 22 12.06C22 6.53 17.5 2.04 12 2.04Z" data-v-4352a182></path></svg></a><a href="#" data-v-4352a182><svg class="social-icon" viewBox="0 0 24 24" data-v-4352a182><path d="M18.9 5.85H21.18L14.22 13.84L22.4 24.65H17.8L14.2 19.89L10.07 24.65H7.78L15.3 16.03L7.5 5.85H12.23L15.28 9.9L18.9 5.85ZM18.09 23.27H19.35L11.51 12.87L18.09 23.27ZM9.69 7.21H8.43L15.93 17.15L9.69 7.21Z" data-v-4352a182></path></svg></a><a href="#" data-v-4352a182><svg class="social-icon" viewBox="0 0 24 24" data-v-4352a182><path d="M7.8,2H16.2C19.4,2 22,4.6 22,7.8V16.2A5.8,5.8 0 0,1 16.2,22H7.8C4.6,22 2,19.4 2,16.2V7.8A5.8,5.8 0 0,1 7.8,2M7.6,4A3.6,3.6 0 0,0 4,7.6V16.4C4,18.39 5.61,20 7.6,20H16.4A3.6,3.6 0 0,0 20,16.4V7.6C20,5.61 18.39,4 16.4,4H7.6M12,7A5,5 0 0,1 17,12A5,5 0 0,1 12,17A5,5 0 0,1 7,12A5,5 0 0,1 12,7M12,9A3,3 0 0,0 9,12A3,3 0 0,0 12,15A3,3 0 0,0 15,12A3,3 0 0,0 12,9M19,5A1,1 0 0,1 20,6A1,1 0 0,1 19,7A1,1 0 0,1 18,6A1,1 0 0,1 19,5Z" data-v-4352a182></path></svg></a></div></div><div class="border-t border-gray-900 mt-8 pt-8 pb-4 bg-black/50" data-v-4352a182><div class="container mx-auto px-4" data-v-4352a182><h4 class="text-xs font-bold text-gray-500 uppercase tracking-widest mb-4" data-v-4352a182>Emergency Service Directory</h4><div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-[10px] text-gray-600" data-v-4352a182><a href="#" class="hover:text-green-500 transition-colors" data-v-4352a182>Air Ambulance Services in Gurgaon</a><a href="#" class="hover:text-green-500 transition-colors" data-v-4352a182>Ambulance near Medanta Hospital</a><a href="#" class="hover:text-green-500 transition-colors" data-v-4352a182>ICU Ambulance Delhi NCR</a><a href="#" class="hover:text-green-500 transition-colors" data-v-4352a182>Air Ambulance India to Nepal</a><a href="#" class="hover:text-green-500 transition-colors" data-v-4352a182>Rail Ambulance Services</a><a href="#" class="hover:text-green-500 transition-colors" data-v-4352a182>24/7 Emergency Medical Flights</a><a href="#" class="hover:text-green-500 transition-colors" data-v-4352a182>Private Ambulance for Hospital Transfer</a><a href="#" class="hover:text-green-500 transition-colors" data-v-4352a182>Road to Air Ambulance Transfer</a><a href="#" class="hover:text-green-500 transition-colors" data-v-4352a182>Event Medical Support Gurgaon</a><a href="#" class="hover:text-green-500 transition-colors" data-v-4352a182>Ventilator Ambulance Service</a><a href="#" class="hover:text-green-500 transition-colors" data-v-4352a182>Trusted Life Support Provider</a><a href="#" class="hover:text-green-500 transition-colors" data-v-4352a182>Emergency Accident Response India</a></div><p class="text-[10px] text-gray-700 mt-8 text-center" data-v-4352a182> © 2025 Ayushmaan Life Support Ambulance. All rights reserved. | <a href="#" class="hover:text-white" data-v-4352a182>Privacy Policy</a></p></div></div></footer>`);
}
...
const AppFooter = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-4352a182"]]);
const _sfc_main$1 = {
  __name: "HomeView",
  __ssrInlineRender: true,
  setup(__props) {
...
const routes = [
  ...
  { path: "/blog", component: () => import("./assets/BlogListView-BJFY-Ley.js") },
  { path: "/blog/:slug", component: () => import("./assets/BlogPostView-Dmr2i7Bh.js") }
];
